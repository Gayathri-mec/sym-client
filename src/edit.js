...
console.log(values)
   ...
   const handleUpdate =(event)=>{
    ...
    axios.put(`http://localhost:2020/change/${sid}`,values)
    .then(res=>{
        console.log(res)
        navigate('/')
    })
    ...
    <div className='w-50 bg-white rounded p-3'>
        <form onSubmit={handleUpdate}>
            ...
            <div className='mb-2'> 
                ...
                <input type='text' placeholder='Enter FirstName' className='form-control' value={values.fristname}
                onChange={e=>setValues({...values,fristname:e.target.value})}/>
            </div>
            <div> 
            ...
            <div> 
                <label>Year</label>
                <input type='number' placeholder='Enter Current Year' className='form-control' value={values.curr_year}
                onChange={e=>setValues({...values,curr_year:e.target.value})}/>
            </div>
            <div> 
